<h1 class="page-header">
    <?php echo $pvd["idProveedor"] != null ? $pvd["razonS"] : 'Nuevo Registro'; ?>
</h1>

<ol class="breadcrumb">
  <li><a href="?c=proveedor">Proveedores</a></li>
  <li class="active"><?php echo $pvd["idProveedor"] != null ? $pvd["razonS"] : 'Nuevo Registro'; ?></li>
</ol>

<form id="frm-proveedor" action="?c=proveedor&a=Editar" method="post" enctype="multipart/form-data">
    <input type="hidden" name="idProveedor" value="<?php echo $pvd["idProveedor"]; ?>" />
